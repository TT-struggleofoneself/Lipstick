...
<style type="text/css">
    ...
    .yg9_content>li:nth-child(1)>.col-md-12{
        ...
        color: white;
        /*background:url(../addons/mzhk_sun/template/images/tuceng4.png) no-repeat center;
        background-size: 100%;*/
    }
    ...
    <div class="col-md-12 vipbanner">
        <div class="col-md-6 vipbig1">
            <div class="col-md-12 vipbox">
                <div class="col-md-12 vipcontent">
                    <div class="vipleft">
                        <img src="../addons/mzhk_sun/template/images/ygrz.png">
                        <span>会员信息</span>
                    </div>
        ...
        <div class="col-md-6 vipbig2">
            <div class="col-md-12 vipbox">
                <div class="col-md-12 vipcontent">
                    <div class="vipleft">
                        <img src="../addons/mzhk_sun/template/images/6.png">
                        <span>订单一览</span>
                    </div>
                ...
                <ul class="col-md-12 vipsell">
                    ...
                    <li class="col-md-12">
                        <div>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-2 xuni">今日：<span><?php  echo $day_order['count'];?></span></div>
                                <div class="col-md-2 xuni">昨日：<span><?php  echo $yesterday_order['count'];?></span></div>
                                <div class="col-md-2 xuni">本月：<span><?php  echo $thismonth_order['count'];?></span></div>
                                <div class="col-md-2 xuni">上月：<span><?php  echo $lastmonth_order['count'];?></span></div>
                                <div class="col-md-2 xuni">今年：<span><?php  echo $thisyear_order['count'];?></span></div>
                            </div>
                        </div>
                    </li>
                </ul>
            ...
            <ul class="col-md-12 yg9_content" style="margin-bottom: 10px;">
                <li class="col-md-3" style="width: 250px;">
                    <div class="col-md-12">
                        ...
                        <p class="tmoney">¥&nbsp;<?php  echo floatval($day_order['money']);?></p>
                ...
                <li class="col-md-3" style="width: 250px;">
                    <div class="col-md-12">
                        ...
                        <p class="tmoney">¥&nbsp;<?php  echo floatval($yesterday_order['money']);?></p>
                        <p class="today">昨日销售总额</p>
                ...
                <li class="col-md-3" style="width: 250px;">
                    <div class="col-md-12">
                        ...
                        <p class="tmoney">¥&nbsp;<?php  echo floatval($thismonth_order['money']);?></p>
                        <p class="today">本月销售总额</p>
                ...
                <li class="col-md-3" style="width: 250px;">
                    <div class="col-md-12" >
                        ...
                        <p class="tmoney">¥&nbsp;<?php  echo floatval($lastmonth_order['money']);?></p>
                        <p class="today">上月销售总额</p>
                ...
                <li class="col-md-3" style="width: 250px;">
                    <div class="col-md-12" >
                        ...
                        <p class="tmoney">¥&nbsp;<?php  echo floatval($thisyear_order['money']);?></p>
                        <p class="today">今年销售总额</p>
