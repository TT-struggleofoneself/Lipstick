...
<?php  $res=pdo_get('mzhk_sun_system',array('uniacid'=>$_W['uniacid']))?>
<div class="header">
    <div class="wheaderbox">
        <img class="header_logo" src="<?php  if($res['link_logo']) { ?><?php  echo tomedia($res['link_logo'])?><?php  } else { ?>../addons/mzhk_sun/template/images/yuanxing.png<?php  } ?>" alt=""/>
    ...
    <ul class="header_right">
        ...
        <?php  } ?>       
        <!-- <li>
            <img src="../addons/mzhk_sun/template/images/tongzhi.png" width="15px" height="18px" alt=""/>
        </li> -->
        <li>
...
box-sizing: border-box;margin-top:10px;padding: 10px;border: 1px solid #f2f2f2;box-sizing: border-box;max-width: 100%;" alt="image" src="<?php  echo tomedia($cur_store['md_logo'])?>" onerror="this.src='../addons/mzhk_sun/template/images/logo.png';"/>
						</span>
						<a href="#" >
