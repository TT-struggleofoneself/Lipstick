...
<ul class="nav nav-tabs">
	...
	<li class="active"><a href="<?php  echo $this->createWebUrl('win_exchange')?>">奖品兑换记录</a></li>
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                         ...
                         <td style="text-align:right;">
                             <a class="btn btn-primary btn-sm" href="<?php  echo $this->createWebUrl('fahuo', array('op' => 'jiangpin', 'id' => $item['id']))?>">发货</a>
                         </td>
                    </tr>
                    <?php  } } ?>
                    <?php  if(empty($list) ) { ?>
